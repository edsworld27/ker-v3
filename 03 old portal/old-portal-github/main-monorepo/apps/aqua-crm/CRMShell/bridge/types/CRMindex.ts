...
// ── LogEntry — CRMShell-extended version with action/details/userName ─────────
// (Bridge LogEntry uses message/timestamp; CRMShell uses action/details/userName)
...
// ── Suite / Bridge Registration (CRMShell-extended versions) ─────────────────
...
// ── SuiteSubItem & SuiteTemplate (CRMShell-extended) ─────────────────────────
