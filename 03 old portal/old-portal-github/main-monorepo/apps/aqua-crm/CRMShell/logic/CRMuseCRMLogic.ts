...
import { useCoreLogic } from '@CRMShell/logic/CRMuseCoreLogic';
import { useAuthLogic } from '@CRMShell/logic/CRMuseAuthLogic';
import { useShellLogic } from '@CRMShell/logic/CRMuseShellLogic';
...
/**
 * useCRMLogic (The Facade Orchestrator)
 * 
...
export function useCRMLogic() {
  ...
  // ── Demo Mode Engine ──────────────────────────────────────────────────────
  const setDemoState = () => {
    import('@CRMShell/bridge/demo/CRMdemoState').then(module => {
