...
import { CRMSidebarContent } from '../Sidebar/CRMSidebarContent';
import { DynamicViewRenderer } from '../Renderer/CRMDynamicViewRenderer';
import { ModalManager } from '@CRMShell/components/CRMModalManager';
import { SmartRegistry } from '@CRMShell/components/CRMSmartRegistry';
import { BridgeRegistry } from '@CRMShell/bridge/CRMRegistration';

// Core Auth Views (Hardcoded in Shell for reliability)
import { WelcomeScreen } from '../components/Auth/CRMWelcomeScreen';
import { LoginView } from '../components/Auth/CRMLoginView';
import { SecurityCheckView } from '../components/Auth/CRMSecurityCheckView';
    ...
    if (this.state.error) {
      ...
      return (
        <div className="flex flex-col items-center justify-center p-16 text-center">
          <p className="text-xl font-bold text-[var(--crm-widget-error)] mb-2">Something went wrong in this view</p>
          <p className="text-sm text-[var(--crm-widget-text-muted)] mb-4 font-mono">{err.message}</p>
