...
// ── LogEntry — FinanceShell-extended version with action/details/userName ─────────
// (Bridge LogEntry uses message/timestamp; FinanceShell uses action/details/userName)
...
// ── Suite / Bridge Registration (FinanceShell-extended versions) ─────────────────
...
// ── SuiteSubItem & SuiteTemplate (FinanceShell-extended) ─────────────────────────
