...
export const dashboardWidgetUI = {
  ...
  wrapper: {
    ...
    border: 'border border-[var(--finance-border-color)]',
    borderHover: 'hover:border-[var(--finance-border-color)]',
  ...
  trend: {
    ...
    positiveBg: 'bg-[color-mix(in_srgb,var(--finance-widget-success)_10%,transparent)]',
    positiveText: 'text-[var(--finance-widget-success)]',
    // neutral / negative trend
    neutralBg: 'bg-slate-500/10',
    neutralText: 'text-[var(--finance-text-color-muted)]',
  },
  ...
  value: {
    ...
    fontWeight: 'font-bold',
    color: 'text-[var(--finance-text-color)]',
    gap: 'mb-0.5 md:mb-1',
  },
  ...
  label: {
    ...
    color: 'text-[var(--finance-text-color-muted)]',
    transform: 'uppercase',
