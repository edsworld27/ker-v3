...
export const dashboardWidgetUI = {
  ...
  wrapper: {
    ...
    border: 'border border-[var(--revenue-widget-border)]',
    borderHover: 'hover:border-[var(--revenue-widget-border)]',
  ...
  trend: {
    ...
    positiveBg: 'bg-[color-mix(in_srgb,var(--revenue-widget-success)_10%,transparent)]',
    positiveText: 'text-[var(--revenue-widget-success)]',
    // neutral / negative trend
    neutralBg: 'bg-slate-500/10',
    neutralText: 'text-[var(--revenue-widget-text-muted)]',
  },
  ...
  value: {
    ...
    fontWeight: 'font-bold',
    color: 'text-[var(--revenue-widget-text)]',
    gap: 'mb-0.5 md:mb-1',
  },
  ...
  label: {
    ...
    color: 'text-[var(--revenue-widget-text-muted)]',
    transform: 'uppercase',
