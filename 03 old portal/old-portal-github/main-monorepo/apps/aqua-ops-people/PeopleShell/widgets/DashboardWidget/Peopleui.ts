...
export const dashboardWidgetUI = {
  ...
  wrapper: {
    ...
    border: 'border border-[var(--people-widget-border)]',
    borderHover: 'hover:border-[var(--people-widget-border)]',
  ...
  trend: {
    ...
    positiveBg: 'bg-[color-mix(in_srgb,var(--people-widget-success)_10%,transparent)]',
    positiveText: 'text-[var(--people-widget-success)]',
    // neutral / negative trend
    neutralBg: 'bg-slate-500/10',
    neutralText: 'text-[var(--people-widget-text-muted)]',
  },
  ...
  value: {
    ...
    fontWeight: 'font-bold',
    color: 'text-[var(--people-widget-text)]',
    gap: 'mb-0.5 md:mb-1',
  },
  ...
  label: {
    ...
    color: 'text-[var(--people-widget-text-muted)]',
    transform: 'uppercase',
