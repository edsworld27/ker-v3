  ...
  card: {
    ...
    header: {
      ...
      statusBadge: {
        ...
        active: 'bg-[color-mix(in_srgb,var(--people-widget-success)_20%,transparent)] text-[var(--people-widget-success)]',
        planning: 'bg-[color-mix(in_srgb,var(--people-widget-info)_20%,transparent)] text-[var(--people-widget-info)]',
      },
    },
    title: 'text-base font-semibold mb-1',
    description: 'text-sm text-[var(--people-widget-text-muted)] mb-4 line-clamp-2',
    details: {
      container: 'space-y-3',
      clientRow: {
        layout: 'flex justify-between items-center',
        labelStyle: 'text-xs text-[var(--people-widget-text-muted)]',
        label: 'Client',
      ...
      progress: {
        ...
        label: 'Progress',
        track: 'w-full h-1.5 bg-[var(--people-widget-surface-color-1-glass)] rounded-full overflow-hidden',
        fillBase: 'h-full bg-gradient-to-r from-[var(--people-widget-primary-color-1)] to-[var(--people-secondary-color,var(--people-widget-primary-color-1))] rounded-full',
      },
    },
  },
};
...
export const projectsStatsWidgetUI = {
  ...
  statLabel: 'text-xs text-[var(--people-widget-text-muted)] truncate',
  icons: {
    briefcase: Briefcase,
    calendar: Calendar,
