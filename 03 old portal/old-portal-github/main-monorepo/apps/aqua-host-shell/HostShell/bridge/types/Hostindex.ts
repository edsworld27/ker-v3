...
/**
 * CORE TYPES — Shared across the HostApp Shell and all Templates.
 *
 * Core entity types (HostUser, Client, Agency, BridgeSession, etc.) are
...
// Aliased Bridge types (Bridge uses non-Host-prefixed names)
export type { PortalProduct as HostPortalProduct } from '@aqua/bridge/types';
export type { PortalTier as HostPortalTier } from '@aqua/bridge/types';
export type { PortalView as HostPortalView } from '@aqua/bridge/types';
export type { AppUser as HostUser } from '@aqua/bridge/types';
export type { AppNotification as HostNotification } from '@aqua/bridge/types';

// ── LogEntry — HostShell-extended version with action/details/userName ─────────
// (Bridge LogEntry uses message/timestamp; HostShell uses action/details/userName)
...
// ── Suite / Bridge Registration (HostShell-extended versions) ─────────────────
...
// ── SuiteSubItem & SuiteTemplate (HostShell-extended) ─────────────────────────
