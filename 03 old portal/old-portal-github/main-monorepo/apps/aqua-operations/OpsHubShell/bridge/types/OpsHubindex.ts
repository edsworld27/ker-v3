...
// ── LogEntry — OpsHubShell-extended version with action/details/userName ─────────
// (Bridge LogEntry uses message/timestamp; OpsHubShell uses action/details/userName)
...
// ── Suite / Bridge Registration (OpsHubShell-extended versions) ─────────────────
...
// ── SuiteSubItem & SuiteTemplate (OpsHubShell-extended) ─────────────────────────
