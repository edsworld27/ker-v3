  ...
  card: {
    ...
    header: {
      ...
      statusBadge: {
        ...
        active: 'bg-[color-mix(in_srgb,var(--opshub-widget-success)_20%,transparent)] text-[var(--opshub-widget-success)]',
        planning: 'bg-[color-mix(in_srgb,var(--opshub-widget-info)_20%,transparent)] text-[var(--opshub-widget-info)]',
      },
    },
    title: 'text-base font-semibold mb-1',
    description: 'text-sm text-[var(--opshub-widget-text-muted)] mb-4 line-clamp-2',
    details: {
      container: 'space-y-3',
      clientRow: {
        layout: 'flex justify-between items-center',
        labelStyle: 'text-xs text-[var(--opshub-widget-text-muted)]',
        label: 'Client',
      ...
      progress: {
        ...
        label: 'Progress',
        track: 'w-full h-1.5 bg-[var(--opshub-widget-surface-1-glass)] rounded-full overflow-hidden',
        fillBase: 'h-full bg-gradient-to-r from-[var(--people-widget-primary-color-1)] to-[var(--opshub-widget-secondary,var(--people-widget-primary-color-1))] rounded-full',
      },
    },
  },
};
...
export const projectsStatsWidgetUI = {
  ...
  statLabel: 'text-xs text-[var(--opshub-widget-text-muted)] truncate',
  icons: {
    briefcase: Briefcase,
    calendar: Calendar,
