...
export const RevenueTopBar: React.FC<RevenueTopBarProps> = ({ appMode, setAppMode, isAgencyRole, impersonatingClientId }) => {
  ...
  return (
    <div className="h-16 border-b border-[var(--revenue-widget-border)] flex items-center justify-center px-4 md:px-8 shrink-0 z-10" style={{ backgroundColor: 'color-mix(in srgb, var(--revenue-bg-color) 80%, transparent)', backdropFilter: 'blur(16px)' }}>
