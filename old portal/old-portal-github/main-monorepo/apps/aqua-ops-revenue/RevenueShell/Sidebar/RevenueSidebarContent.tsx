...
import { getSidebarItems } from './RevenueSidebarLogic';
import { BridgeRegistry } from '@RevenueShell/bridge/RevenueRegistration';

export const RevenueSidebarContent: React.FC = () => {
  const ctx = useRevenueContext();
  ...
  return (
    <AppSidebar
      ...
      appLabel="Revenue"
      primaryColorVar="var(--revenue-widget-primary-color-1)"
