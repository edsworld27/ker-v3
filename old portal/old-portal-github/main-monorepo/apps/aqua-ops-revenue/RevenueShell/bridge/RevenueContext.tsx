...
export const RevenueProvider: React.FC<{ children: ReactNode, value: RevenueContextType }> = ({ children, value }) => {
...
export const useRevenueContext = () => {
  ...
  if (context === undefined) {
    throw new Error('useRevenueContext must be used within an RevenueProvider');
  }
  return context;
};
