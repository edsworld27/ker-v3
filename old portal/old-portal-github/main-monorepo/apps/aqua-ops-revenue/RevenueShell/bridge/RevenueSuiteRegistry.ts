...
import { RevenueRegistration } from './RevenueRegistration';

/**
 * Suite Metadata Registry
 * 
 * Defines how suites are grouped and displayed in the sidebar.
 * This is now reactive, pulling from the RevenueRegistration.
 */
export const SUITE_METADATA = {
  get all() {
    return RevenueRegistration.getSuites().map(suite => ({
      ...suite,
