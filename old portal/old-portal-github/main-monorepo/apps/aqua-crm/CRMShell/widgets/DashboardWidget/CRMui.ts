...
export const dashboardWidgetUI = {
  ...
  wrapper: {
    ...
    border: 'border border-[var(--crm-widget-border)]',
    borderHover: 'hover:border-[var(--crm-widget-border)]',
  ...
  trend: {
    ...
    positiveBg: 'bg-[color-mix(in_srgb,var(--crm-widget-success)_10%,transparent)]',
    positiveText: 'text-[var(--crm-widget-success)]',
    // neutral / negative trend
    neutralBg: 'bg-slate-500/10',
    neutralText: 'text-[var(--crm-widget-text-muted)]',
  },
  ...
  value: {
    ...
    fontWeight: 'font-bold',
    color: 'text-[var(--crm-widget-text)]',
    gap: 'mb-0.5 md:mb-1',
  },
  ...
  label: {
    ...
    color: 'text-[var(--crm-widget-text-muted)]',
    transform: 'uppercase',
