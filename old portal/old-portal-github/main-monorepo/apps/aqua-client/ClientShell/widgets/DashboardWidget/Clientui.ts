...
export const dashboardWidgetUI = {
  ...
  wrapper: {
    ...
    borderHover: 'hover:border-[var(--client-widget-border)]',
  ...
  trend: {
    ...
    positiveBg: 'bg-[color-mix(in_srgb,var(--client-widget-success)_10%,transparent)]',
    positiveText: 'text-[var(--client-widget-success)]',
    // neutral / negative trend
    neutralBg: 'bg-slate-500/10',
    neutralText: 'text-[var(--client-widget-text-muted)]',
  },
  ...
  value: {
    ...
    fontWeight: 'font-bold',
    color: 'text-[var(--client-widget-text)]',
    gap: 'mb-0.5 md:mb-1',
  },
  ...
  label: {
    ...
    color: 'text-[var(--client-widget-text-muted)]',
    transform: 'uppercase',
