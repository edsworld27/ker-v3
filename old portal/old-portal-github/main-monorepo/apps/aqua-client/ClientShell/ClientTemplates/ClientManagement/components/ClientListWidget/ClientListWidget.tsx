...
import { Search, Filter, MoreHorizontal, Building2, Mail, Globe } from 'lucide-react';
...
export const ClientListWidget: React.FC = () => {
  ...
  const { data: clients = [] } = useDesignAwareData(context.clients, 'admin-clients-list-widget');
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          ...
          <div className="relative w-full sm:w-auto">
            ...
            >
              ...
              <option value="discovery" className="bg-[var(--client-widget-bg-color-1)]">Discovery</option>
              <option value="onboarding" className="bg-[var(--client-widget-bg-color-1)]">Onboarding</option>
              <option value="design" className="bg-[var(--client-widget-bg-color-1)]">Design</option>
              <option value="development" className="bg-[var(--client-widget-bg-color-1)]">Development</option>
              <option value="live" className="bg-[var(--client-widget-bg-color-1)]">Live</option>
            </select>
          </div>
        </div>
      </div>
