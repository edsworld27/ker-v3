...
export const PeopleProvider: React.FC<{ children: ReactNode, value: PeopleContextType }> = ({ children, value }) => {
...
export const usePeopleContext = () => {
  ...
  if (context === undefined) {
    throw new Error('usePeopleContext must be used within an PeopleProvider');
  }
  return context;
};
