...
// ── LogEntry — PeopleShell-extended version with action/details/userName ─────────
// (Bridge LogEntry uses message/timestamp; PeopleShell uses action/details/userName)
...
// ── Suite / Bridge Registration (PeopleShell-extended versions) ─────────────────
...
// ── SuiteSubItem & SuiteTemplate (PeopleShell-extended) ─────────────────────────
