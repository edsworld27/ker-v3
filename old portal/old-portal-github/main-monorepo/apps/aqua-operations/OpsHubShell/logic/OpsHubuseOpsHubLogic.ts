...
import { useCoreLogic } from '@OpsHubShell/logic/OpsHubuseCoreLogic';
import { useAuthLogic } from '@OpsHubShell/logic/OpsHubuseAuthLogic';
import { useShellLogic } from '@OpsHubShell/logic/OpsHubuseShellLogic';
...
export function useOpsHubLogic() {
  ...
  // ── Demo Mode Engine ──────────────────────────────────────────────────────
  const setDemoState = () => {
    import('@OpsHubShell/bridge/demo/OpsHubdemoState').then(module => {
