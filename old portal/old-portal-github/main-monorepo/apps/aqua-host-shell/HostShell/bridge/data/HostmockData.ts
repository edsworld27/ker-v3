// @ts-nocheck
import {
  HostUser, Client, Project, ProjectTask, AppTicket, LogEntry, Todo, Deal,
  SetSailGift, YouDeserveItAllowance,
  HostNotification, PayrollRecord, ARInvoice,
...
export const initialUsers: HostUser[] = [
  {
    id: 999,
    name: 'Demo Admin',
  ...
  { 
    ...
    taxProfile: {
      ...
      workAddress: { line1: 'HostAqua HQ', city: 'London', state: 'Greater London', postalCode: 'W1 1AA', country: 'UK', lat: 51.5074, lng: -0.1278 },
...
export const initialProjects: Project[] = [
  { id: 'proj-1', name: 'HostAqua HostPortal V2', clientId: 'client-1', description: 'Internal refactor and feature expansion.', status: 'Active', createdAt: '2026-03-01', budgetLimitCents: 1000000, burnRateThreshold: 0.8, hourlyRateTargetCents: 15000 },
...
export const initialActivityLogs: LogEntry[] = [
  ...
  { id: '2', timestamp: new Date().toISOString(), userId: 1, userName: 'Founder', action: 'HostPortal Access', details: 'Accessed Agency Hub', type: 'action' },
];
...
export const initialNotifications: HostNotification[] = [
