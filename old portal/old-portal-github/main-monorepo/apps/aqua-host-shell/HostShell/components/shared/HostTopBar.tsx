...
export const HostTopBar: React.FC<HostTopBarProps> = ({ appMode, setAppMode, isAgencyRole, impersonatingClientId }) => {
  ...
  const modes = [
    ...
    { mode: 'client-portal-demo',label: 'HostPortal Preview' },
    { mode: 'settings',          label: 'Settings' },
  ];

  return (
    <div className="h-16 border-b border-[var(--host-border-color)] flex items-center justify-center px-4 md:px-8 shrink-0 z-10" style={{ backgroundColor: 'color-mix(in srgb, var(--host-bg-color) 80%, transparent)', backdropFilter: 'blur(16px)' }}>
