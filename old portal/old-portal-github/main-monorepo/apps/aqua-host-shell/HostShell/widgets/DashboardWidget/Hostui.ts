...
export const dashboardWidgetUI = {
  ...
  wrapper: {
    ...
    border: 'border border-[var(--host-border-color)]',
    borderHover: 'hover:border-[var(--host-border-color)]',
  ...
  trend: {
    ...
    positiveBg: 'bg-[color-mix(in_srgb,var(--host-widget-success)_10%,transparent)]',
    positiveText: 'text-[var(--host-widget-success)]',
    // neutral / negative trend
    neutralBg: 'bg-slate-500/10',
    neutralText: 'text-[var(--host-text-color-muted)]',
  },
  ...
  value: {
    ...
    fontWeight: 'font-bold',
    color: 'text-[var(--host-text-color)]',
    gap: 'mb-0.5 md:mb-1',
  },
  ...
  label: {
    ...
    color: 'text-[var(--host-text-color-muted)]',
    transform: 'uppercase',
