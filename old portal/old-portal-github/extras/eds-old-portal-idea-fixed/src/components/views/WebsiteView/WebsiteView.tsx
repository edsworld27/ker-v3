...
export const WebsiteView: React.FC<WebsiteViewProps> = (props) => {
  const ctx = useAppContext();
  const handleViewChange = props.handleViewChange ?? ctx.handleViewChange;
  const handleExportWebsite = props.handleExportWebsite ?? (() => alert('Website export not implemented in this build.'));
  return (
    <motion.div
      key="website"
