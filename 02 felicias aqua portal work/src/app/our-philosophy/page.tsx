...
const SECTIONS = [
  {
    ...
    body: [
      "Phthalates are a family of chemicals added to fragrances as fixatives. Scent compounds are volatile — they evaporate quickly and break down in light. Phthalates slow that breakdown, meaning a perfume or soap holds its smell longer on the shelf and on your skin. Diethyl phthalate (DEP) is the most common in personal care.",
  ...
  },
  {
    ...
    body: [
      ...
      "Repeated SLS exposure has been linked to skin barrier disruption and contact dermatitis, particularly in sensitive skin. [5] We don't use them in Odo or Nkrabea. Real soap doesn't need them — shea butter and saponified oils produce a creamy lather without the strip.",
    ],
  },
  {
    eyebrow: "Section 04",
  ...
  },
  {
    ...
    body: [
      ...
      "Phthalates are most often hidden inside fragrance blends, which is why a product can claim to be 'phthalate-free' in body but still contain them inside its scent. We name every essential oil in both our Odo and Nkrabea ranges, including the supplier and the part of the plant it's pressed from.",
    ],
  },
  {
    eyebrow: "Section 06",
    ...
    body: [
      ...
      "Skin is not a barrier. It is a permeable, living organ that absorbs what you put on it — and what you wash off sits in waterways and food chains for decades. That's why we believe everyone — women and men — deserves to know exactly what's going on their skin.",
    ],
  },
];
        ...
        <section className="w-full bg-brand-black relative overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-4xl mx-auto px-6 sm:px-10 lg:px-12 py-16 sm:py-20 lg:py-24">
            ...
            <div className="flex flex-wrap gap-3 mb-8">
              <Link href="/products?range=odo" className="px-5 py-2 rounded-full border border-brand-orange/40 text-brand-orange text-sm font-medium hover:bg-brand-orange/10 transition-colors">
                Odo · For Her →
              </Link>
              <Link href="/products?range=nkrabea" className="px-5 py-2 rounded-full border border-brand-amber/40 text-brand-amber text-sm font-medium hover:bg-brand-amber/10 transition-colors">
                Nkrabea · For Him →
              </Link>
            </div>
        ...
        <section className="w-full bg-brand-black-soft border-t border-white/5">
          <div className="w-full max-w-4xl mx-auto px-6 sm:px-10 lg:px-12 py-14 sm:py-20 text-center">
            <p className="font-display italic text-brand-cream text-xl sm:text-2xl xl:text-3xl leading-relaxed max-w-2xl mx-auto mb-3">
              Luv for her. Ker for him.
            </p>
            <p className="font-display text-2xl sm:text-3xl xl:text-4xl font-bold mb-10">
              <span className="gradient-text">One philosophy. Two ranges.</span>
            </p>
            ...
            <p className="text-brand-cream/60 text-base sm:text-lg max-w-xl mx-auto mb-8 leading-relaxed">
              No phthalates. No parabens. No sulphates. No synthetic fragrance. Just shea butter, black soap base,
              and named essential oils — across every product in every range.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              >
                Shop Odo · For Her <span>→</span>
              </Link>
              <Link
                href="/products?range=nkrabea"
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full border border-brand-amber/40 text-brand-amber hover:bg-brand-amber/10 transition-colors text-sm sm:text-base font-semibold"
              >
                Shop Nkrabea · For Him <span>→</span>
              </Link>
            </div>
          </div>
        </section>
