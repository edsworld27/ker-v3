...
// 02 felicias aqua portal work/src/components/editor/blocks/VideoBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function VideoBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="video" data-block-id={block.id}>
