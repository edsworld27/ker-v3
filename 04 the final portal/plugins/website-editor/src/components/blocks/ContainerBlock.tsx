...
// 02 felicias aqua portal work/src/components/editor/blocks/ContainerBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function ContainerBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="container" data-block-id={block.id}>
