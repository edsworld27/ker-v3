...
// 02 felicias aqua portal work/src/components/editor/blocks/ProductCardBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function ProductCardBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="product-card" data-block-id={block.id}>
