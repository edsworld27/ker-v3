...
// 02 felicias aqua portal work/src/components/editor/blocks/GalleryBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function GalleryBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="gallery" data-block-id={block.id}>
