...
// 02 felicias aqua portal work/src/components/editor/blocks/ContactFormBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function ContactFormBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="contact-form" data-block-id={block.id}>
