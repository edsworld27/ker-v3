...
// 02 felicias aqua portal work/src/components/editor/blocks/BeforeAfterBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function BeforeAfterBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="before-after" data-block-id={block.id}>
