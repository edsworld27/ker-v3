// ThemeSelectorBlock — theme-selector
//
...
// 02 felicias aqua portal work/src/components/editor/blocks/ThemeSelectorBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function ThemeSelectorBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="theme-selector" data-block-id={block.id}>
