// BookingWidgetBlock — booking-widget
//
...
// 02 felicias aqua portal work/src/components/editor/blocks/BookingWidgetBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function BookingWidgetBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="booking-widget" data-block-id={block.id}>
