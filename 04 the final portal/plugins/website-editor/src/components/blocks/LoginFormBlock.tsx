...
// 02 felicias aqua portal work/src/components/editor/blocks/LoginFormBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function LoginFormBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="login-form" data-block-id={block.id}>
