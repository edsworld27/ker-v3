...
// 02 felicias aqua portal work/src/components/editor/blocks/FooterBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function FooterBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="footer" data-block-id={block.id}>
