...
// 02 felicias aqua portal work/src/components/editor/blocks/LogoGridBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function LogoGridBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="logo-grid" data-block-id={block.id}>
