// OrderSuccessBlock — order-success
//
...
// 02 felicias aqua portal work/src/components/editor/blocks/OrderSuccessBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function OrderSuccessBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="order-success" data-block-id={block.id}>
