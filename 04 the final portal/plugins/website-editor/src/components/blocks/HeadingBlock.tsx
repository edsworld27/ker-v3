...
// 02 felicias aqua portal work/src/components/editor/blocks/HeadingBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function HeadingBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="heading" data-block-id={block.id}>
