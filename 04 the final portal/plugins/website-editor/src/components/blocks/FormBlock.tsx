...
// 02 felicias aqua portal work/src/components/editor/blocks/FormBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function FormBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="form" data-block-id={block.id}>
