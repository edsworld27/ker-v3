// ProductSearchBlock — product-search
//
...
// 02 felicias aqua portal work/src/components/editor/blocks/ProductSearchBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function ProductSearchBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="product-search" data-block-id={block.id}>
