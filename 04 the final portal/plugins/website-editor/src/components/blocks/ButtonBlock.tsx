...
// 02 felicias aqua portal work/src/components/editor/blocks/ButtonBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function ButtonBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="button" data-block-id={block.id}>
