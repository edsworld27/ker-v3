...
// 02 felicias aqua portal work/src/components/editor/blocks/ColumnBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function ColumnBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="column" data-block-id={block.id}>
