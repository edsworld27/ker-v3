...
// 02 felicias aqua portal work/src/components/editor/blocks/GridBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function GridBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="grid" data-block-id={block.id}>
