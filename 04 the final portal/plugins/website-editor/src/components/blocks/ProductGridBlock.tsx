...
// 02 felicias aqua portal work/src/components/editor/blocks/ProductGridBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function ProductGridBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="product-grid" data-block-id={block.id}>
