// VariantPickerBlock — variant-picker
//
...
// 02 felicias aqua portal work/src/components/editor/blocks/VariantPickerBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function VariantPickerBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="variant-picker" data-block-id={block.id}>
