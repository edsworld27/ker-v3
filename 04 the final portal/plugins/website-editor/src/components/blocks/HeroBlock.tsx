...
// 02 felicias aqua portal work/src/components/editor/blocks/HeroBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function HeroBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="hero" data-block-id={block.id}>
