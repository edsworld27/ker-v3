...
// 02 felicias aqua portal work/src/components/editor/blocks/AccordionBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function AccordionBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="accordion" data-block-id={block.id}>
