...
// 02 felicias aqua portal work/src/components/editor/blocks/MapBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function MapBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="map" data-block-id={block.id}>
