...
// 02 felicias aqua portal work/src/components/editor/blocks/BannerBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function BannerBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="banner" data-block-id={block.id}>
