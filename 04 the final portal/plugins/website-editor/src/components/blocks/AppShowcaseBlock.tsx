...
// 02 felicias aqua portal work/src/components/editor/blocks/AppShowcaseBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function AppShowcaseBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="app-showcase" data-block-id={block.id}>
