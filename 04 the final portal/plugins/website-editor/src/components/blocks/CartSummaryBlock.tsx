...
// 02 felicias aqua portal work/src/components/editor/blocks/CartSummaryBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function CartSummaryBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="cart-summary" data-block-id={block.id}>
