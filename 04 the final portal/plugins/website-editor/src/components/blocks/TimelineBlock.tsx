...
// 02 felicias aqua portal work/src/components/editor/blocks/TimelineBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function TimelineBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="timeline" data-block-id={block.id}>
