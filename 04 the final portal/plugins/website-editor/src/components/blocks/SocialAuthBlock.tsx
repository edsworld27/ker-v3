...
// 02 felicias aqua portal work/src/components/editor/blocks/SocialAuthBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function SocialAuthBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="social-auth" data-block-id={block.id}>
