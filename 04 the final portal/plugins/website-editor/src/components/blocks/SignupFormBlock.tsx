...
// 02 felicias aqua portal work/src/components/editor/blocks/SignupFormBlock.tsx.

import type { BlockComponentProps } from "../blockRegistry";
import { BlockRenderer } from "../BlockRenderer";

export function SignupFormBlock({ block, children }: BlockComponentProps) {
  const childBlocks = block.children ?? [];
  return (
    <div data-block-type="signup-form" data-block-id={block.id}>
