...
import { getPage, updatePage, deletePage, type UpdatePageInput } from "@/portal/server/pages";

// GET    /api/portal/pages/[siteId]/[pageId]  — load a single page
// PATCH  /api/portal/pages/[siteId]/[pageId]  — partial update (title/slug/description/blocks/themeId/customCss/...)
