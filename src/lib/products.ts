...
export const PRODUCTS: Product[] = [
  ...
  // ── Nkrabea · For Him ──────────────────────────────────────────────────────
  {
    ...
    directions:
      "Wet face with warm water. Work the bar into a lather and massage into skin for 30–60 seconds. Rinse with cool water and pat dry.",
    benefits: [
  ...
  },
  {
    ...
    description: [
      ...
      "Formulated to soothe razor burn, body breakouts, and post-gym inflammation. Long-lasting solid bar format — one bar outlasts three bottles of shower gel.",
    ],
    ...
    directions:
      "In the shower, work the bar into a rich lather. Massage into skin from shoulders to feet. Leave for 30 seconds and rinse. Hang bar to dry between uses.",
    benefits: [
  ...
  },
  {
    ...
    description: [
      "Nkrabea Shave replaces every aerosol can in your bathroom. A traditional hard soap lather that creates dense, glycerin-rich foam to lift stubble, cushion the blade, and leave skin calm and nourished after every shave.",
      "Formulated with the same black soap heritage base as the full Nkrabea range — so your shave ritual and skincare are finally speaking the same language.",
    ],
    ...
    directions:
      "Wet the bar and face with warm water. Swirl a damp brush on the bar to load lather, then work into the beard in circular motions. Shave as normal. No brush? Rub the bar directly onto damp skin and lather with your hands.",
    benefits: [
  ...
  },
  {
    ...
    description: [
      ...
      "Designed to make the switch to natural skincare effortless. Everything a man needs, in one considered package.",
    ],
    note: "Limited handwoven pouches",
    formats: ["bar"],
    ...
    directions:
      "Use Nkrabea Face morning and night. Use Nkrabea Body in the shower. Use Nkrabea Shave before the blade. Store everything in the pouch between uses.",
    benefits: [
      { icon: "🎁", title: "Ready to gift", body: "Arrives wrapped — no assembly required." },
      { icon: "🧺", title: "Handwoven pouch", body: "Made by women artisans in Bolgatanga, Ghana." },
